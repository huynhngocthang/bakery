    ...
    <body class="hold-transition login-page front-login">
        <div class="login-box wrap-login">
            <div class="login-logo">
               <img src="<?php echo site_url('public/assets/images/common/img-slider.png') ?>" style="width: 100px;">
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                <p class="login-box-msg">Thay đổi mật khẩu<u></u></p>

                <form action="<?php echo site_url() ?>/<?php echo $url_1 ?>/<?php echo $url_2 ?>/<?php echo $email_code ?><?php if (isset($send_code)) {
	echo "/" . $send_code;
}
?>" method="post">
                    <?php if (isset($msg)) {?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        <h4><i class="icon fa fa-ban"></i> Đỗi mật khẩu thất bại!</h4>
                        <?php echo $msg; ?>
                    </div>
                    <?php }?>
                    ...
                    <div class="row">
                        <!-- /.col -->
                        <div class="col-xs-4">
                            <button type="submit" name="submit" class="btn btn-primary btn-block btn-flat" value="1">Hoàn tất</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
