...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?php echo site_url('admin/sales') ?>">Khuyến mãi</a></li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Cập nhật Khuyễn mãi</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                    ...
                    <div class="form-group">
                        ...
                        <select id="category_id" name="product_id[]" class="select2 form-control" multiple="" required=""  >
                            ...
                            foreach ($products as $value) {
                                echo recursive_option_3($value, $selected_prod);
                            }
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group col-sm-6">
                                ...
                                <input class="form-control" data-format="hh:mm:ss" name="timestart" type="time" value="
                                <?php
                                    $date = date_create($sales->start_date);
