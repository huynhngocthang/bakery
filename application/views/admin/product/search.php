...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <form method="POST" action="/admin/product/searchproduct">
                    ...
                    <form id="frmMain" method="POST" action="/admin/product/action">
                        ...
                        <div class="box-footer clearfix">
                            <?php echo custom_pagination('/admin/product/searchproduct/' . $data['keyword'], $data['total'], $total_page); ?>
                        </div>
                    </form>
                    <!-- /.box-body -->
                </div>
