            ...
            <form role="form" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id[]" class="select2 form-control" multiple="" required="" >
                            <?php
                            foreach ($category_lineage as &$category) {
                                if ($category->parent_id == 0) {
                                    echo recursive_option($category, array());
                                }
                            }
                            ?>
...
<?php echo form_label('Ảnh sản phẩm', 'feature_image'); ?>
                        <input type="text" name="image" class="form-control" id="txtSelectedFile" style="cursor:pointer;" value="Chọn ảnh" onclick="openCustomRoxy('roxyCustomPanel2', '<?php echo site_url() ?>fileman/custom.html?integration=custom&type=files&txtFieldId=txtSelectedFile&preview=thumbPreview&dialog=roxyCustomPanel2')">
                    ...
                    <div class="form-group">
                        ...
                        <a class="btn btn-primary " onclick="openCustomRoxy('roxyCustomPanel3', '<?php echo site_url() ?>fileman/custom.html?integration=custom&type=files&is_other=1&dialog=roxyCustomPanel3')"><i class="fa fa-plus"></i> Thêm ảnh</a>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" id="price" name="price" placeholder="">
                    </div>
                    <div class="form-group">
