...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                     <form method="POST" action="<? echo site_url()?>admin/order/searchorder/<?php echo $this->uri->segment(4) ?>">
                    ...
                    <form id="frmMain" method="POST" action="<? echo site_url()?>admin/order/action">
                        ...
                        <div class="box-footer clearfix">
                            <?php echo custom_pagination(site_url('admin/order/searchorder/') . $data['date'] . '/' . $data['keyword'], $data['total'], $total_page); ?>
                        </div>
                    </form>
                    <!-- /.box-body -->
                </div>
